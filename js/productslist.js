...
(function ($) {
    $(function () {
        ...
        $('.box .multiple').click(function () {
            ...
            if ($box_dd.hasClass("brand")) {
                height += 17;
                $box_dd.find(".ac").removeClass("initial");
            }
            ...
            $box_dd.find(".cancel").click(function () {
                if ($box_dd.hasClass("brand")) {
                    $box_dd.find(".multiple").data("brand", false);
                    $(".kay").hide();
                    $box_dd.find(".ac").addClass("initial");
                }
        ...
        /*品牌选项卡*/
        /*取消*/
        $('.box dd.brand .switch').click(function () {
        ...
        $(' .box dd.brand .multiple').click(function () {
            if ($(this).data("brand") == undefined || $(this).data("brand") == false) {
                $(".kay").show();
                $(this).data("brand", true);
            }
        });
